...
<head>
    ...
    <title>Nastavitve | Schedulizer</title>
    <!-- Font imports -->
    ...
    <style>
        ...
        * {
        ...
        /* Toggle container - LIGHT/DARK MODE BUTTON GOES HERE */
        ...
        .toggle-container {
            ...
            gap: 0.75rem;
            /* prostor med label in gumbom */
            margin-bottom: 2rem;
            /* enako kot form-group */
        }
        ...
        /* Appearance card: indent the language picker to match the “Theme” toggle */

        .card-body {
            padding: 2.5rem;
        }

        /* ensure toggle rows all start at 2.5rem in */
        .toggle-container {
            display: flex;
            align-items: left;
            gap: 1rem;
            margin-bottom: 2rem;
            padding-left: 2.5rem;
            /* ← match your .card-body padding */
        }

        /* override the weird select reset at bottom */
        ...
        *:before {
        ...
        :root {
            ...
            --bg: linear-gradient(135deg, #3A82F7 0%, #00C2FF 100%);
            --bear-speed: 10s;
            --color: #ffffff;
        }
        ...
        /* Switch styles for notifications */
        .switch-container {
            display: flex;
            align-items: center;
...
<body class="<?= $lightMode ? 'light' : 'dark' ?>">
    <div id="main-content">
        <div class="settings-container">
            ...
            <div class="page-header">
                ...
                <p class="page-subtitle">Customize the app to suit your needs.</p>
            </div>

            <!-- Alert Messages -->
            <?php if (isset($_SESSION['settings_message'])): ?>
                <div class="alert alert-<?= $_SESSION['settings_message_type'] ?? 'success' ?>">
                    <i class="fas fa-check-circle alert-icon"></i>
                    <?= $_SESSION['settings_message'] ?>
                </div>
                <?php
                // Počistimo sporočilo po prikazu
            ...
            <form method="post" action="settings.php">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fas fa-palette card-header-icon"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="toggle-container">
                            ...
                            <div class="controls" style="position: absolute; left: 0; bottom: 0; opacity: 0; pointer-events: none;">
                    ...
                    <div class="form-group toggle-container">
                        ...
                        <select id="language" name="language" class="form-select">
                            <option value="sl" <?= $userSettings['language'] === 'sl' ? 'selected' : '' ?>>English</option>
                            <option value="en" <?= $userSettings['language'] === 'en' ? 'selected' : '' ?> disabled>Slovenian (cooming soon)</option>
                            <option value="de" <?= $userSettings['language'] === 'de' ? 'selected' : '' ?> disabled>Deutsch (cooming soon)</option>
                            <option value="it" <?= $userSettings['language'] === 'it' ? 'selected' : '' ?> disabled>Italiano (cooming soon)</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fas fa-bell card-header-icon"></i>
                    ...
                    <div class="card-body">
                        <div class="switch-container">
                            ...
                            <div>
                                <span class="switch-label">E-mail Notifications</span>
                                <p class="switch-desc">Get notifications about new events via email</p>
                            </div>
                        </div>

                        <div class="switch-container">
                            <label class="switch">
                                <input type="checkbox" name="event_notifications" <?= $userSettings['event_notifications'] ? 'checked' : '' ?>>
                                <span class="switch-slider"></span>
                            </label>
                            <div>
                                <span class="switch-label">Notifications o dogodkih</span>
                                <p class="switch-desc">Receive reminders about upcoming events</p>
                            </div>
                        </div>

                        <div class="switch-container">
                            <label class="switch">
                                <input type="checkbox" name="weekly_summary" <?= $userSettings['weekly_summary'] ? 'checked' : '' ?>>
                                <span class="switch-slider"></span>
                            </label>
                            <div>
                                <span class="switch-label">Tedenski povzetki</span>
                                <p class="switch-desc">Receive weekly summaries of your activity</p>
                            </div>
                        </div>
    ...
    <!-- JavaScript za shranjevanje teme -->
    <script>
        ...
        fetch('get_theme.php')
            ...
            .then(({
                ...
                const isDark = light_mode === 0;
                toggleBtn.setAttribute("aria-pressed", isDark ? "true" : "false");
                document.body.classList.toggle("dark", isDark);
            });

        // 2) Ob kliku preklopi in shrani
        toggleBtn.addEventListener("click", () => {
            const isDark = toggleBtn.getAttribute("aria-pressed") === "true";
            const newMode = isDark ? 1 : 0; // če je zdaj dark, postavi light (1), sicer dark (0)
